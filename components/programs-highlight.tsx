    ...
    >
      <div className="container mx-auto px-6 lg:px-12">
        ...
        <div className="text-center mb-20">
          ...
          >
            Recognition is not a luxury—it is a catalyst. These initiatives
            honor resilience, amplify unheard voices, and build community
            belief.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8 max-w-6xl mx-auto mb-16">
          {featuredPrograms.map((program, index) => (
            <div
              key={index}
              className={`program-card group relative p-8 lg:p-12 bg-surface border border-border rounded-2xl hover-lift magnetic transition-all duration-1000 ${
                isVisible
                  ? "opacity-100 translate-y-0"
                  : "opacity-0 translate-y-10"
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="text-text-muted text-sm">
                    + {program.features.length - 2} more features
                  </div>
                </div>
              </div>
            </div>
        ...
        >
          <div className="max-w-2xl mx-auto space-y-8">
            ...
            <p className="text-text-secondary">
              Nominate a resilient woman, host a conversation, or partner to
              amplify the next wave of awakened gems.
            </p>
