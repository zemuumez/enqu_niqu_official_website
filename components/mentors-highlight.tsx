...
export default function MentorsHighlight() {
  const { t } = useLanguage();
    ...
    >
      <div className="container mx-auto px-6 lg:px-12">
        ...
        <div className="text-center mb-16">
          ...
          >
            Guided by a family-centered founding team and powered by women whose lived experiences shape every award,
            dialogue, and story.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          ...
          >
            <div className="relative mb-6" style={{ width: 128, height: 128, margin: '0 auto' }}>
        ...
        >
          <div className="text-center">
            ...
            <div className="text-text-secondary text-sm">Empowerment gatherings</div>
          </div>
          <div className="text-center">
        ...
        >
          <div className="max-w-2xl mx-auto space-y-8">
            ...
            <p className="text-text-secondary">
              Learn about the founders and the women whose stories shape every gathering, panel, and initiative we host.
            </p>
