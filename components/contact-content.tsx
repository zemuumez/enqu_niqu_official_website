...
export default function ContactContent() {
  ...
  return (
    <section id="contact" ref={sectionRef} className="section-padding bg-background pt-24">
      <div className="container mx-auto px-4 lg:px-12">
        ...
        <div className="text-center mb-16 py-11">
          ...
          <p className="text-xl text-text-secondary max-w-3xl mx-auto leading-relaxed fade-in-up">
            Share a resilient woman&apos;s story, explore partnerships, or host an ENQU SET NIQU SET conversation. We respond
            with care to every message.
          </p>
        </div>
          ...
          <div className="space-y-8 fade-in-up">
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-text-muted text-sm mt-1">Community platform</p>
                  </div>
                </div>
            ...
            <div className="institutional-card">
              ...
              <div className="space-y-3">
                ...
                <button className="w-full btn-secondary">Host a Conversation</button>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-2 fade-in-up">
            <div className="institutional-card">
              ...
              <form className="space-y-6">
                ...
                <div>
                  <label htmlFor="program" className="block text-sm font-medium text-text-primary mb-2">
                  ...
                  >
                    ...
                    <option value="host">Host a panel/storytelling session</option>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <label htmlFor="newsletter" className="text-sm text-text-secondary">
                    I would like to receive updates about ENQU SET NIQU SET awards, stories, and events.
                  </label>
                </div>
        ...
        <div className="fade-in-up">
          <div className="institutional-card overflow-hidden py-11">
            <h3 className="text-2xl font-bold mb-6 text-text-primary text-center">What&apos;s Next</h3>
            <div className="grid md:grid-cols-3 gap-6 text-center">
              <div className="space-y-2">
                <p className="text-sm uppercase tracking-wide text-text-muted">Upcoming Event</p>
                <p className="text-xl font-semibold text-text-primary">January 6</p>
                <p className="text-text-secondary text-sm">Award gathering & storytelling</p>
              </div>
              <div className="space-y-2">
                <p className="text-sm uppercase tracking-wide text-text-muted">Podcast</p>
                <p className="text-xl font-semibold text-text-primary">Launching soon</p>
                <p className="text-text-secondary text-sm">Featuring honorees and nominees</p>
              </div>
              <div className="space-y-2">
                <p className="text-sm uppercase tracking-wide text-text-muted">Community</p>
                <p className="text-xl font-semibold text-text-primary">7 events held</p>
                <p className="text-text-secondary text-sm">Built on trust, authenticity, and belief</p>
              </div>
            </div>
            <div className="mt-6 text-center">
              <p className="text-text-secondary mb-4">
                ENQU SET NIQU SET has grown organically—powered by real stories, family leadership, and a community that believes
                recognition is a catalyst.
              </p>
        ...
        <div className="mt-16 fade-in-up py-11">
          <div className="text-center mb-12">
            <h3 className="text-2xl font-bold mb-4 text-text-primary">Frequently Asked Questions</h3>
            <p className="text-text-secondary">
              Quick answers about nominations, events, and collaborating with ENQU SET NIQU SET
            </p>
          </div>

          <div className="grid md:grid-cols-2 gap-8 mb-16">
            <div className="institutional-card border-t-2 pt-2.5">
              <h4 className="font-semibold text-text-primary mb-2">How do nominations work?</h4>
              <p className="text-text-secondary text-sm">
                Share a woman&apos;s story through our form. We review submissions with care and reach out for
                additional context before each gathering.
              </p>
            </div>
            <div className="institutional-card border-t-2 pt-2.5">
              <h4 className="font-semibold text-text-primary mb-2">Who can be honored?</h4>
              <p className="text-text-secondary text-sm">
                Survivors, community changemakers, quiet contributors, and role models who transformed adversity into
                purpose—titles are not required.
              </p>
            </div>
            <div className="institutional-card pt-2.5 border-t-2">
              <h4 className="font-semibold text-text-primary mb-2">How are events funded?</h4>
              <p className="text-text-secondary text-sm">
                We grow through trust and authentic partnerships, not hype. Sponsors and collaborators help keep the
                focus on recognition and impact.
              </p>
            </div>
            <div className="institutional-card pt-2.5 border-t-2">
              <h4 className="font-semibold text-text-primary mb-2">Can men participate?</h4>
              <p className="text-text-secondary text-sm">
                Absolutely. While ENQU SET NIQU SET centers women, allies are welcome to nominate, attend, and support the
                movement.
              </p>
            </div>
          </div>
