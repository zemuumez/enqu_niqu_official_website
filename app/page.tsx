...
export default function Home() {
  ...
  const session6Dir = path.join(process.cwd(), "public", "images", "Session#6");
  const session7Dir = path.join(process.cwd(), "public", "images", "Session#7");
  ...
  const session6Images = readPublicImages(session6Dir, "/images/Session#6");
  const session7Images = readPublicImages(session7Dir, "/images/Session#7");
